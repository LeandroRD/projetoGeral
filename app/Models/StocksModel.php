...
class StocksModel extends Model
{
    ...
    {
        $request = \Config\Services::request();
        $params2 = $request->getPost('select_parent');
        
        //selecionar tudo o que foi postado
        $servico = $_POST;

        //pegar o ultimo registro que é o fornecedor
        ...
        $results = $this->query('SELECT * FROM cotacao_servicos WHERE id_for = ?', $params2)->getResult('array');
