<?php
    ...
    $acompanhamento = $cotacao['acompanhamento'];
?>
<?php $this->section('conteudo')?>
    <div class="row mt-2">
		<div class="col-12 text-center ">
			<h3>Acompanhamento de serviços - Fornecedor</h3>
        </div>
        <div class="col-md-6 col-md-offset-3 marg-fundo card card-claro">
            <form action="<?php echo site_url('stocks/cotacao_editar_fornecedor_aprovada/'.$id_cotacao) ?>" method="post">
                <?php if(isset($error)): ?>
                ...
                <div class="mt-3 marg-fundo">
                    ...
                    <!-- acompanhamento-->
                    <label>Acomphamento do serviço:</label>
                    <input  class="form-control" type="text"  name="text_acompanhamento" value = "<?php echo $acompanhamento?>" required >
                </div>
                <br>
                <!-- Modal -------------------->
